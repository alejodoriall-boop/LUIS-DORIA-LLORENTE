...
export const DairyView: React.FC<DairyViewProps> = ({
  ...
  return (
    ...
    <div className="space-y-6 w-full pb-12">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          {onOpenMastitisModal && (
            ...
            >
              ...
              {activeMastitisCount > 0 && (
                <span className="bg-[#15241C] text-red-800 text-[9.5px] font-bold px-1.5 py-0.5 rounded-full font-mono leading-none">
                  {activeMastitisCount}
                </span>
              )}
            </button>
          ...
          <button
            ...
            className="h-8 px-3 bg-[#D4A94E] hover:bg-[#fcd34d] text-[#0D1A13] font-bold text-[11px] rounded-lg shadow-xs transition-all flex items-center justify-center gap-1.5 active:scale-95 duration-100 uppercase tracking-wider cursor-pointer"
          >
            <Radio className="w-3.5 h-3.5 text-[#0D1A13]" />
      ...
      <div className="bg-[#15241C] border border-white/10 text-white p-4 md:p-5 rounded-2xl shadow-xs relative overflow-hidden">
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="space-y-1.5">
            <div className="flex flex-wrap items-center gap-2">
              ...
              <span className="bg-emerald-950/30 text-emerald-800 font-mono text-[10.5px] font-semibold px-2.5 py-0.5 rounded-full border border-emerald-200">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 shrink-0">
            <button
              onClick={onOpenMilkingModal}
              className="bg-[#0D1A13] hover:bg-[#1F3327] border border-white/15 text-white font-semibold text-xs px-4 py-2.5 rounded-xl transition-all flex items-center justify-center gap-2 cursor-pointer shadow-2xs"
            >
        ...
        <div className="mt-4 pt-3 border-t border-white/10 grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs">
          <div className="bg-slate-50/80 p-2.5 rounded-xl border border-white/10">
            <span className="text-[10px] uppercase text-[#A5B8AC] block font-semibold">Lector Conectado</span>
            <span className="font-mono font-bold text-white text-xs">{rfidConfig?.readerBrand || 'Tru-Test SRS2'}</span>
          </div>

          <div className="bg-slate-50/80 p-2.5 rounded-xl border border-white/10">
            <span className="text-[10px] uppercase text-[#A5B8AC] block font-semibold">Protocolo Conexión</span>
            <span className="font-mono font-bold text-amber-700 text-xs uppercase">{rfidConfig?.connectionType || 'Bluetooth'} LE</span>
          </div>

          <div className="bg-slate-50/80 p-2.5 rounded-xl border border-white/10">
            <span className="text-[10px] uppercase text-[#A5B8AC] block font-semibold">Auto-Flujómetro</span>
          ...
          <div className="bg-slate-50/80 p-2.5 rounded-xl border border-white/10">
            <span className="text-[10px] uppercase text-[#A5B8AC] block font-semibold">Control Medicamentos</span>
      ...
      <div className="bg-[#15241C] border border-white/10 p-4 rounded-2xl shadow-xs space-y-3">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-white/10 pb-2.5">
          <div className="flex items-center gap-2">
            <div className="p-2 bg-emerald-950/30 text-emerald-700 rounded-xl border border-emerald-100">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-5 gap-2.5 text-xs">
          ...
          <div
            ...
            className="bg-[#0D1A13] hover:bg-emerald-50/50 p-3 rounded-xl border border-white/10 hover:border-emerald-500 shadow-2xs cursor-pointer transition-all active:scale-98 group flex flex-col justify-between"
            title="Haz clic para ver las vacas en ordeño"
          >
            <div>
              <div className="flex items-center justify-between">
                <span className="text-[10px] font-bold uppercase tracking-wider text-[#A5B8AC] block">
                  Vacas en Ordeño
                </span>
          ...
          <div
            ...
            className="bg-[#0D1A13] hover:bg-amber-50/50 p-3 rounded-xl border border-white/10 hover:border-amber-500 shadow-2xs cursor-pointer transition-all active:scale-98 group flex flex-col justify-between"
          ...
          >
            <div>
              ...
              <span className="text-[9.5px] text-[#A5B8AC] font-medium">Gestación / Periodo seco</span>
            </div>
          ...
          <div
            ...
            className="bg-[#0D1A13] hover:bg-sky-50/50 p-3 rounded-xl border border-white/10 hover:border-sky-500 shadow-2xs cursor-pointer transition-all active:scale-98 group flex flex-col justify-between"
          ...
          <div
            ...
            className="bg-[#0D1A13] hover:bg-purple-50/50 p-3 rounded-xl border border-white/10 hover:border-purple-500 shadow-2xs cursor-pointer transition-all active:scale-98 group flex flex-col justify-between"
      ...
      {cowMilkingList.length > 0 && (
        <div className="bg-[#15241C] rounded-2xl border border-white/10 p-4 md:p-5 shadow-xs space-y-3">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse text-xs">
              <thead>
                <tr className="bg-[#0D1A13] text-white font-semibold text-[10.5px] uppercase border-b border-white/10">
                ...
                {cowMilkingList.map((cow) => (
                  <tr key={cow.id} className="hover:bg-slate-50/70 transition-colors">
                    <td className="p-2.5 font-sans">
                      <span className="font-bold text-white">{cow.cowTag}</span>
                      <span className="block text-[10px] text-[#A5B8AC]">{cow.cowName} ({cow.breed || 'Lechera'})</span>
                    </td>
                    ...
                    <td className="p-2.5 font-sans">
                      <span className={`px-2 py-0.5 rounded text-[10px] font-semibold ${
                        cow.chipStandard === 'FDX-B'
                          ? 'bg-sky-950/30 text-sky-800 border border-sky-200'
                          : 'bg-purple-950/30 text-purple-800 border border-purple-200'
                      }`}>
                        {cow.chipStandard}
                      </span>
                    </td>

                    <td className="p-2.5 text-center font-sans text-[#A5B8AC]">
                      {cow.lactationDays} d
                    </td>
                    ...
                    <td className="p-2.5 text-center font-sans">
                      {cow.hasMedicineAlert ? (
                        <span className="bg-rose-950/30 text-rose-800 border border-rose-200 text-[10px] font-semibold px-2 py-0.5 rounded-md inline-flex items-center gap-1" title={cow.medicineNotes}>
                          <ShieldAlert className="w-3.5 h-3.5 text-rose-600" />
                          Retención Fármaco
                        </span>
                      ) : (
                        <span className="bg-emerald-950/30 text-emerald-800 border border-emerald-200 text-[10px] font-semibold px-2 py-0.5 rounded-md inline-flex items-center gap-1">
      ...
      {/* ========================================================================= */}
      <div className="bg-[#15241C] text-white rounded-2xl p-4 md:p-5 border border-white/10 shadow-xs space-y-4">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3 border-b border-white/10 pb-3.5">
          <div>
            <div className="flex items-center gap-2 flex-wrap">
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] font-mono font-bold uppercase tracking-wider bg-emerald-950/30 text-emerald-800 border border-emerald-200">
                <Milk className="w-3.5 h-3.5 text-emerald-700" /> Estándares Zootécnicos Lecheros
              </span>
            </div>
            <h3 className="text-base md:text-lg font-bold text-white mt-1 flex items-center gap-2">
          ...
          {/* Navigation Subtabs */}
          <div className="flex flex-wrap items-center gap-1.5 bg-slate-100/90 p-1.5 rounded-xl border border-white/10">
            <button
              type="button"
              ...
              className={`px-3 py-1.5 rounded-lg font-mono text-xs font-semibold transition-all cursor-pointer flex items-center gap-1.5 ${
                dairyStandardsSubTab === 'reproductivo'
                  ...
                  : 'text-[#A5B8AC] hover:text-white hover:bg-slate-200/60'
              }`}
            >
        ...
        {dairyStandardsSubTab === 'reproductivo' && (
          <div className="space-y-3 animate-in fade-in">
            <div className="overflow-x-auto rounded-xl border border-white/10 bg-[#15241C] font-mono">
              <table className="w-full text-left text-xs">
                <thead>
                  <tr className="bg-[#0D1A13] text-white text-[10.5px] uppercase tracking-wider border-b border-white/10 font-semibold">
                ...
                <tbody className="divide-y divide-slate-100 text-white">
                  <tr className="hover:bg-slate-50/60">
                    ...
                    <td className="p-3 text-[#A5B8AC] text-[11px] font-sans">Cuando alcanza 55%-60% del peso adulto (330-360 kg Holstein; 240-270 kg Jersey).</td>
                  </tr>
                  ...
                  <tr className="hover:bg-slate-50/60">
                    ...
                    <td className="p-3 text-[#A5B8AC] text-[11px] font-sans">Reducir la EPP disminuye los costos de levante de novilla antes de iniciar vida productiva.</td>
                  </tr>
                  ...
                  <tr className="hover:bg-slate-50/60">
                    ...
                    <td className="p-3 text-[#A5B8AC] text-[11px] font-sans">Un IEP &gt; 420 días genera pérdidas económicas por días en anestro o fallas reproductivas.</td>
                  </tr>
                  ...
                  <tr className="hover:bg-slate-50/60">
                    ...
                    <td className="p-3 text-[#A5B8AC] text-[11px] font-sans">Días entre el parto y la nueva concepción. La meta es preñar la vaca antes del día 110.</td>
                  </tr>
                  ...
                  <tr className="hover:bg-slate-50/60">
                    ...
                    <td className="p-3 text-[#A5B8AC] text-[11px] font-sans">Tiempo de descanso mamario y regeneración celular previo al siguiente parto.</td>
                  </tr>
                  ...
                  <tr className="hover:bg-slate-50/60">
                    ...
                    <td className="p-3 text-[#A5B8AC] text-[11px] font-sans">Inseminaciones requeridas por gestación (balance nutricional y detección de celo).</td>
                  </tr>
                  ...
                  <tr className="hover:bg-slate-50/60">
                    ...
                    <td className="p-3 text-[#A5B8AC] text-[11px] font-sans">Vacas reemplazadas por baja producción, mastitis recurrente o fertilidad.</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        {dairyStandardsSubTab === 'curva' && (
          <div className="space-y-4 animate-in fade-in">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 font-mono">
              ...
              <div className="p-3.5 bg-[#0D1A13] rounded-xl border border-white/10 space-y-1">
                <div className="flex items-center justify-between">
                  <span className="text-xs text-[#A5B8AC] font-bold uppercase flex items-center gap-1.5">
                ...
                <div className="text-2xl font-bold text-white">305 Días</div>
                <p className="text-[11px] text-[#A5B8AC] font-sans leading-snug">
            ...
            <div className="bg-slate-50/80 p-4 rounded-xl border border-white/10 space-y-3">
              ...
              <div className="h-64 w-full bg-[#15241C] p-3 rounded-xl border border-white/10">
            ...
            <div className="bg-slate-50/80 p-4 rounded-xl border border-white/10 space-y-3">
              ...
              <div className="h-60 w-full bg-[#15241C] p-3 rounded-xl border border-white/10">
                <ResponsiveContainer width="100%" height="100%">
                  <ComposedChart
                    data={[
            ...
            <div className="p-3.5 bg-[#0D1A13] rounded-xl border border-white/10 space-y-2.5 font-mono text-xs">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-2.5">
                <div className="p-3 bg-[#15241C] rounded-xl border border-white/10 space-y-1">
                  ...
                  <div className="text-lg font-bold text-white">7,500 – 10,000+ L</div>
                  <p className="text-[10px] text-[#A5B8AC] font-sans">Máximo volumen por vaca con balance de fibra efectiva.</p>
                </div>
                ...
                <div className="p-3 bg-[#15241C] rounded-xl border border-white/10 space-y-1">
                  ...
                  <div className="text-lg font-bold text-white">5,500 – 7,000 L</div>
                  <p className="text-[10px] text-[#A5B8AC] font-sans">Alta conversión por kg de peso y elevado % de grasa y proteína.</p>
                </div>
                ...
                <div className="p-3 bg-[#15241C] rounded-xl border border-white/10 space-y-1">
                  ...
                  <div className="text-lg font-bold text-white">2,500 – 4,500 L</div>
                  <p className="text-[10px] text-[#A5B8AC] font-sans">Rusticidad y adaptación total al calor y trópico bajo.</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <table className="w-full text-left text-xs">
                <thead>
                  <tr className="bg-[#0D1A13] text-white text-[10.5px] uppercase tracking-wider border-b border-white/10 font-semibold">
                    ...
                    <th className="p-3 bg-sky-950/30 text-sky-900">Estándar Holstein</th>
                    <th className="p-3 bg-amber-950/30 text-amber-900">Estándar Jersey</th>
                ...
                <tbody className="divide-y divide-slate-100 text-white">
                  <tr className="hover:bg-slate-50/60">
                    ...
                    <td className="p-3 text-[#A5B8AC] text-[11px] font-sans">Fuente principal de sólidos. Afectada por la fibra efectiva en dieta.</td>
                  </tr>
                  ...
                  <tr className="hover:bg-slate-50/60">
                    ...
                    <td className="p-3 text-[#A5B8AC] text-[11px] font-sans">Determina el rendimiento quesero y precio bonificado.</td>
                  </tr>
                  ...
                  <tr className="hover:bg-slate-50/60">
                    ...
                    <td className="p-3 text-[#A5B8AC] text-[11px] font-sans">Base para la liquidación tarifaria por litro.</td>
                  </tr>
                  ...
                  <tr className="hover:bg-slate-50/60">
                    ...
                    <td className="p-3 text-[#A5B8AC] text-[11px] font-sans">Indicador directo de salud de la ubre y mastitis subclínica.</td>
                  </tr>
                  ...
                  <tr className="hover:bg-slate-50/60">
                    ...
                    <td className="p-3 text-[#A5B8AC] text-[11px] font-sans">Higiene en ordeño, lavado de pezoneras y cadena de frío (&lt; 4 °C).</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        {dairyStandardsSubTab === 'calculadora' && (
          <div className="p-4 bg-[#0D1A13] rounded-xl border border-white/10 space-y-4 font-mono animate-in fade-in">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 border-b border-white/10 pb-2.5">
              <div>
                <h4 className="font-bold text-xs text-white uppercase flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs">
              ...
              <div className="bg-[#15241C] p-3.5 rounded-xl border border-white/10 space-y-2">
                <div className="flex justify-between items-center">
                  <label className="text-white font-bold">1. Litros Alcanzados en el Pico (45-60 DIM):</label>
                  <span className="font-bold text-base text-emerald-800 bg-emerald-950/30 px-2.5 py-0.5 rounded border border-emerald-200">
                    {simPeakLiters} L / día
                  </span>
                </div>
                <input
                ...
                />
                <div className="flex justify-between text-[10px] text-[#A5B8AC]">
              ...
              <div className="bg-[#15241C] p-3.5 rounded-xl border border-white/10 space-y-2">
                <label className="text-white font-bold block">2. Seleccionar Raza Base:</label>
            ...
            {(() => {
              ...
              return (
                <div className="p-3.5 bg-[#15241C] rounded-xl border border-white/10 grid grid-cols-2 md:grid-cols-4 gap-2.5 text-center">
                  <div className="p-2.5 bg-sky-50/70 rounded-lg border border-sky-100">
                    <span className="text-[10px] text-[#A5B8AC] block uppercase font-medium">Proyección 305 Días</span>
                  ...
                  <div className="p-2.5 bg-emerald-50/70 rounded-lg border border-emerald-100">
                    <span className="text-[10px] text-[#A5B8AC] block uppercase font-medium">Rango Meta</span>
                  ...
                  <div className="p-2.5 bg-amber-50/70 rounded-lg border border-amber-100">
                    <span className="text-[10px] text-[#A5B8AC] block uppercase font-medium">Grasa Esperada</span>
                  ...
                  <div className="p-2.5 bg-purple-50/70 rounded-lg border border-purple-100">
                    <span className="text-[10px] text-[#A5B8AC] block uppercase font-medium">Proteína Esperada</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
        ...
        <div className="md:col-span-6 bg-[#15241C] rounded-2xl border border-white/10 p-4 md:p-5 tactical-shadow flex flex-col justify-between">
          <div>
            ...
            <div className="grid grid-cols-2 gap-3 mb-4">
              {/* Turno Mañana */}
              <div className="bg-[#eeeeee] p-3 rounded-xl border-b-2 border-white/10">
          ...
          <div className="h-36 w-full relative bg-[#0D1A13] rounded-xl overflow-hidden border border-white/10 p-2 flex flex-col justify-between">
            <div className="flex items-center justify-between z-10">
              <div className="bg-[#15241C] border border-white/10 px-2 py-0.5 rounded text-[10px] font-bold text-white uppercase tracking-wider">
                CURVA DE LACTANCIA (PROMEDIO)
              </div>
              <div className="flex gap-1 bg-[#15241C] border border-white/10 p-0.5 rounded-lg text-[9px]">
                <button
                  onClick={() => setSelectedCurveView('promedio')}
                  className={`px-1.5 py-0.5 rounded cursor-pointer transition-colors ${
                    selectedCurveView === 'promedio' ? 'bg-[#123F2A] text-[#D4A94E] font-bold border border-[#D4A94E]/30' : 'text-[#A5B8AC]'
                  }`}
                >
                  Promedio
                </button>
                <button
                  ...
                  className={`px-1.5 py-0.5 rounded cursor-pointer transition-colors ${
                    selectedCurveView === 'multiparas' ? 'bg-[#123F2A] text-[#D4A94E] font-bold border border-[#D4A94E]/30' : 'text-[#A5B8AC]'
                  }`}
                >
                  Multíparas
                </button>
              ...
              >
                ...
                <defs>
                  <linearGradient id="lactationGrad" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stopColor="#27885D" stopOpacity="0.4" />
                    <stop offset="100%" stopColor="#0D1A13" stopOpacity="0.0" />
                  </linearGradient>
                </defs>
                ...
                <circle cx="75" cy="18" r="4" fill="#D4A94E" stroke="#0D1A13" strokeWidth="2" />
              </svg>

              <div className="absolute top-1 left-24 text-[9px] font-mono text-[#D4A94E] font-bold bg-[#15241C] border border-[#D4A94E]/40 px-1.5 py-0.5 rounded shadow-xs">
                Pico: 38.5 L (Día 60)
              </div>
            </div>

            <div className="flex justify-between text-[9px] font-mono text-[#A5B8AC] px-1 border-t border-white/10 pt-0.5">
              <span>0 DIM</span>
        ...
        <div className="md:col-span-6 bg-[#15241C] rounded-2xl border border-white/10 p-4 md:p-5 tactical-shadow flex flex-col justify-between">
          <div>
            ...
            <div className="space-y-3.5">
              {/* Días Abiertos */}
              <div className="flex items-center justify-between p-3.5 border border-white/10 rounded-xl bg-[#f9f9f9] border-l-4 border-l-[#ffba38]">
                <div>
                ...
                <div className="bg-[#D4A94E]/30 text-[#0D1A13] px-2.5 py-1 rounded-lg text-[10px] font-bold uppercase">
                  OBJETIVO: &lt; 120
                </div>
              </div>

              {/* Intervalo Entre Partos (IEP) */}
              <div className="flex items-center justify-between p-3.5 border border-white/10 rounded-xl bg-[#f9f9f9] border-l-4 border-l-[#1b4332]">
                <div>
                  <p className="text-[10px] font-bold uppercase tracking-wider text-[#414844]">
                    INTERVALO ENTRE PARTOS (IEP)
                  </p>
          ...
          <div className="grid grid-cols-2 gap-3 mt-4 pt-3 border-t border-[#eeeeee]">
            <div className="text-center p-2 bg-[#f3f3f3] rounded-lg">
              ...
              <p className="text-base font-bold font-mono text-white">62.4%</p>
            </div>
            <div className="text-center p-2 bg-[#f3f3f3] rounded-lg">
              <p className="text-[10px] text-[#717973] font-semibold">Preñez General del Hato</p>
              <p className="text-base font-bold font-mono text-white">88.1%</p>
            </div>
          </div>
        </div>

        {/* Card 3: Calidad de Leche (Spans 4 cols) */}
        <div className="md:col-span-4 bg-[#15241C] rounded-2xl border border-white/10 p-4 md:p-5 tactical-shadow flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-3">
              <h3 className="text-xs font-bold uppercase tracking-wider text-[#79564b]">
                CALIDAD DE LECHE
            ...
            <ul className="space-y-2 text-xs">
              ...
              <li className="flex justify-between items-center py-2 border-b border-[#eeeeee]">
                <span className="font-medium text-white">Grasa Butírica</span>
              ...
              {/* Proteína */}
              <li className="flex justify-between items-center py-2 border-b border-[#eeeeee]">
                <span className="font-medium text-white">Proteína Verdadera</span>
                <span className="font-mono font-bold text-white text-sm">
              ...
              <li className="flex justify-between items-center py-2">
                <div className="flex flex-col">
                  <span className="font-medium text-white">RCS</span>
          ...
          <div className="mt-3 pt-2 space-y-2">
            {onOpenMastitisModal && (
              <button
                onClick={onOpenMastitisModal}
                className="w-full bg-[#0D1A13] hover:bg-[#123F2A] text-white p-2.5 rounded-xl text-xs font-bold transition-all flex items-center justify-between cursor-pointer shadow-2xs"
              >
                <div className="flex items-center gap-2">
        ...
        <div className="md:col-span-8 bg-[#15241C] rounded-2xl border border-white/10 p-4 md:p-5 tactical-shadow flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-3">
              <h3 className="text-xs font-bold uppercase tracking-wider text-[#79564b]">
                PRÓXIMAS A SECADO O PARTO
              </h3>
              <button className="text-white text-xs font-bold hover:underline flex items-center gap-1">
                  ...
                  {upcomingEvents.map((evt) => (
                    ...
                    >
                      <td className="py-2.5 pl-2 flex items-center gap-2 font-sans">
                        ...
                        <span className="font-semibold text-white">{evt.cowName}</span>
                      </td>
                      ...
                      <td className="py-2.5 text-right pr-2">
                        <button
                          ...
                          className="bg-[#f3f3f3] hover:bg-[#c1ecd4] text-white px-2 py-1 rounded-lg text-[10px] font-sans font-bold transition-colors"
