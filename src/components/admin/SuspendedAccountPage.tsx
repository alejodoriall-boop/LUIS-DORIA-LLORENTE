  ...
  return (
    <div className="min-h-screen w-full bg-[#0D1A13] text-[#FFFFFF] flex flex-col items-center justify-center p-4 sm:p-6 selection:bg-[#D4A94E]/30 selection:text-[#FFFFFF]">
      <motion.div
        ...
        className="w-full max-w-md bg-[#0D1A13] rounded-3xl border border-amber-500/20 shadow-2xl p-6 sm:p-8 text-center space-y-6"
      >
        ...
        <div className="p-4 rounded-2xl bg-[#15241C] border border-white/10 text-xs text-left space-y-2.5">
          ...
          <div className="space-y-1.5 text-[11px] text-[#A5B8AC]">
            <div className="flex items-center gap-2">
              <Mail className="w-3.5 h-3.5 text-[#D4A94E]" />
        ...
        <button
          ...
          className="w-full py-2.5 px-4 bg-[#15241C] hover:bg-[#1A251E] text-[#FFFFFF] font-semibold text-xs rounded-xl border border-white/10 transition-all flex items-center justify-center gap-2 cursor-pointer"
        >
