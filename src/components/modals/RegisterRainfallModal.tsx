...
export const RegisterRainfallModal: React.FC<RegisterRainfallModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4 overflow-y-auto animate-in fade-in" onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}>
      <div className="bg-white rounded-3xl border-2 border-[#012d1d] shadow-2xl max-w-3xl lg:max-w-5xl lg:max-w-6xl w-full overflow-hidden flex flex-col">
        {/* Modal Header */}
        <div className="bg-[#012d1d] text-white p-5 flex items-center justify-between border-b-2 border-[#ffba38]">
          <div className="flex items-center gap-3">
            <div className="p-2.5 bg-[#1b4332] rounded-2xl text-[#c1ecd4] border border-[#2d6a4f]">
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full p-3 bg-[#f8fbf9] border-2 border-[#c1c8c2] rounded-2xl text-sm font-bold text-[#012d1d] focus:border-[#012d1d] focus:outline-none"
            >
              {farms.map((f) => (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                className="w-full p-3 bg-white border-2 border-[#c1c8c2] rounded-2xl text-sm font-bold text-[#012d1d] focus:border-[#012d1d] focus:outline-none"
                required
              />
            </div>
          ...
          <div className="bg-[#f0f7f4] border-2 border-[#c1ecd4] rounded-2xl p-3.5 space-y-2 text-xs">
            <div className="flex items-center justify-between text-[#012d1d] font-black">
              <span className="flex items-center gap-1.5 uppercase text-[10px] tracking-wider text-[#2d6a4f]">
                <Ruler className="w-4 h-4 text-[#012d1d]" /> Equivalencia Hidrológica:
              </span>
              <span className="bg-[#012d1d] text-[#c1ecd4] font-mono text-[10px] px-2 py-0.5 rounded font-bold">
                1 mm = 1 L/m²
              </span>
            </div>

            <div className="grid grid-cols-3 gap-2 text-center pt-1 border-t border-[#c1ecd4]/60">
              <div className="bg-white p-2 rounded-xl border border-[#c1ecd4]">
                <span className="text-[9px] text-[#717973] block uppercase font-bold">Por m²</span>
                <span className="font-mono font-black text-[#012d1d] text-sm">{litersPerM2} L</span>
              </div>
              <div className="bg-white p-2 rounded-xl border border-[#c1ecd4]">
              ...
              <div className="bg-[#012d1d] text-white p-2 rounded-xl">
                <span className="text-[9px] text-[#c1ecd4] block uppercase font-bold">En la Finca ({farmAreaHa} Ha)</span>
