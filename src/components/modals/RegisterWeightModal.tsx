      ...
      <div className="bg-white rounded-3xl max-w-xl w-full border border-[#c1c8c2] shadow-2xl overflow-hidden my-auto">
        ...
        <div className="bg-[#012d1d] text-white px-5 py-3.5 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            <div className="p-2 bg-[#ffba38] text-[#523700] rounded-xl shadow-sm">
          ...
          <div className="flex items-center gap-1.5">
            {activeScale && (
              <button
                ...
                className="px-2 py-1 bg-white hover:bg-[#f3f3f3] border border-[#a5d0b9] text-[#002114] font-bold rounded-lg text-[11px] flex items-center gap-1 transition-colors"
              >
            ...
            <button
              ...
              className="px-2.5 py-1 bg-[#012d1d] hover:bg-[#1b4332] text-white font-bold rounded-lg text-[11px] flex items-center gap-1 shadow-xs transition-colors"
            >
        ...
        <form onSubmit={handleSave} className="p-5 space-y-4 text-xs">
          {/* WEIGHING TYPE TABS */}
          <div className="flex bg-[#f3f3f3] p-1 rounded-2xl border border-[#c1c8c2]">
            <button
              type="button"
          ...
          <div className="flex items-center justify-between bg-white p-2.5 rounded-2xl border border-[#c1c8c2]">
            ...
            <div className="flex gap-1 bg-[#f3f3f3] p-1 rounded-xl">
              <button
                ...
                className={`px-3 py-1 rounded-lg text-xs font-bold flex items-center gap-1.5 transition-all ${
                  inputMode === 'live_scale'
                    ? 'bg-[#ffba38] text-[#523700] shadow-xs'
                    : 'text-[#414844] hover:text-[#012d1d]'
                }`}
              >
          ...
          {/* LOT SELECTOR */}
          <div>
            <label className="block text-[11px] font-bold text-[#012d1d] uppercase mb-1">
              Potrero / Lote Destino
            </label>
            <select
              value={selectedLotId}
              onChange={(e) => setSelectedLotId(e.target.value)}
              className="w-full bg-[#f9f9f9] border border-[#c1c8c2] rounded-xl px-3 py-2 text-xs font-bold text-[#1a1c1c] focus:outline-none focus:border-[#012d1d]"
            >
              {lots.map((l) => (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#f9f9f9] border border-[#c1c8c2] rounded-xl px-3 py-2 text-xs font-bold font-mono text-[#012d1d] focus:outline-none focus:border-[#012d1d]"
                />
              </div>
              ...
              <div>
                ...
                <div className="flex gap-1.5">
                  <input
                    ...
                    className="flex-1 bg-[#e8e8e8] border border-[#c1c8c2] rounded-xl px-2.5 py-2 text-[11px] font-mono text-[#414844]"
                  />
                  <button
                    type="button"
                    onClick={handleScanRFID}
                    title="Escanear arete con bastón RFID"
                    className="px-2.5 py-2 bg-[#ffba38]/30 hover:bg-[#ffba38]/50 border border-[#dc9a00] text-[#523700] font-bold rounded-xl text-xs flex items-center gap-1"
                  >
            ...
            <div className="bg-[#00180f] rounded-2xl p-4 md:p-5 border-2 border-[#012d1d] shadow-lg text-center relative overflow-hidden">
              ...
              <div className="inline-flex items-center gap-1.5 px-3 py-0.5 rounded-full text-[11px] font-mono font-bold uppercase tracking-wider mb-2">
                {reading.weight === 0 ? (
                  ...
                  <span className="bg-[#1b4332] text-[#c1ecd4] border border-[#2d6a4f] px-2.5 py-0.5 rounded-full flex items-center gap-1">
                    <CheckCircle2 className="w-3 h-3 text-emerald-400" />
                    PESO ESTABLE 🔒 [LISTO]
                  </span>
                ) : (
                  <span className="bg-[#ffba38]/20 text-[#ffba38] border border-[#ffba38]/40 px-2.5 py-0.5 rounded-full flex items-center gap-1 animate-pulse">
              ...
              {/* Big Digital Weight */}
              <div className="my-1">
                <span className="font-mono text-5xl md:text-6xl font-black text-[#c1ecd4] tracking-tight drop-shadow-[0_0_20px_rgba(45,106,79,0.7)]">
              ...
              <div className="flex flex-wrap items-center justify-center gap-2 mt-3 pt-3 border-t border-[#1b4332]">
                <button
                  ...
                  className="bg-[#ffba38] hover:bg-[#ffdeac] text-[#523700] font-bold px-4 py-2 rounded-xl text-xs flex items-center gap-1.5 tactical-shadow transition-all active:scale-95"
                >
                ...
                <button
                  ...
                  className="bg-[#1b4332] hover:bg-[#2d6a4f] text-white font-bold px-3 py-2 rounded-xl text-xs flex items-center gap-1.5 transition-all"
                >
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#f9f9f9] border border-[#c1c8c2] rounded-xl px-3 py-2 text-xs font-semibold focus:outline-none focus:border-[#012d1d]"
                  required
                />
              </div>
            </div>
          ...
          {weighingType === 'batch_chute' && (
            <div className="bg-[#f9f9f9] p-3.5 rounded-2xl border border-[#c1c8c2] space-y-3">
              <div className="flex items-center justify-between">
                <div>
                  <h4 className="font-bold text-xs text-[#012d1d] flex items-center gap-1.5">
                ...
                <button
                  ...
                  className="bg-[#012d1d] hover:bg-[#1b4332] text-white font-bold px-3 py-1.5 rounded-xl text-xs flex items-center gap-1 shadow-xs transition-colors"
                >
              ...
              {batchItems.length > 0 ? (
                <div className="max-h-36 overflow-y-auto space-y-1.5 pr-1">
                  {batchItems.map((item, idx) => (
                    <div
                      key={item.id}
                      className="bg-white p-2 rounded-xl border border-[#c1c8c2] flex items-center justify-between text-xs"
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          <span className="font-bold text-[#012d1d]">Arete #{item.animalTag}</span>
                ...
                <div className="text-center py-4 text-xs text-[#717973] bg-white rounded-xl border border-dashed border-[#c1c8c2]">
              ...
              <div className="text-right">
                <span
                  className={`font-mono text-base md:text-lg font-black ${
                    isPositiveGain ? 'text-[#012d1d]' : 'text-red-700'
                  }`}
                >
          ...
          <div className="flex gap-2 pt-3 border-t border-[#eeeeee]">
            <button
              type="submit"
              className="flex-1 bg-[#ffba38] hover:bg-[#ffdeac] text-[#523700] font-bold py-3 rounded-xl text-xs flex items-center justify-center gap-1.5 tactical-shadow transition-colors active:scale-98"
            >
