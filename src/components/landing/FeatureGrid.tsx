...
export const FeatureGrid: React.FC = () => {
  ...
  return (
    <section id="modulos" className="py-24 bg-[#F8FAFC] relative overflow-hidden border-y border-white/10">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="mt-4 text-base sm:text-lg text-[#A5B8AC] font-normal leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-12 gap-6">
          ...
          <div
            id="whatsapp"
            className="lg:col-span-8 bg-[#15241C] rounded-2xl p-6 sm:p-8 border border-white/10/90 shadow-xs hover:shadow-md transition-all flex flex-col justify-between group relative overflow-hidden"
          >
            <div className="absolute top-0 right-0 w-64 h-64 bg-emerald-950/30 rounded-full blur-3xl -z-10 group-hover:bg-emerald-100/70 transition-colors" />
            ...
            <div>
              <div className="flex items-center justify-between gap-4 mb-4">
                ...
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-950/30 text-emerald-800 border border-emerald-200 text-xs font-bold">
              ...
              <p className="mt-2 text-[#A5B8AC] text-sm sm:text-base leading-relaxed max-w-2xl">
            ...
            <div className="mt-6 bg-[#00281c] rounded-xl p-4 sm:p-5 border border-emerald-900/40 text-white shadow-inner">
              ...
              <div className="space-y-2.5 text-xs sm:text-sm">
                ...
                <div className="flex justify-start">
                  <div className="bg-[#1F3327] text-emerald-100 px-3.5 py-2 rounded-2xl rounded-tl-xs max-w-xs sm:max-w-md border border-white/15">
          ...
          <div
            id="bubalinos"
            className="lg:col-span-4 bg-[#15241C] rounded-2xl p-6 sm:p-8 border border-white/10/90 shadow-xs hover:shadow-md transition-all flex flex-col justify-between relative overflow-hidden group"
          >
            <div>
              ...
              <p className="mt-2 text-[#A5B8AC] text-sm leading-relaxed">
            ...
            <div className="mt-6 pt-4 border-t border-neutral-100 space-y-2">
              <div className="flex items-center justify-between text-xs font-semibold text-[#A5B8AC]">
                <span>Gestación Bubalina</span>
                <span className="text-amber-800 font-mono">310 - 315 días</span>
              </div>
              <div className="w-full bg-[#1F3327] rounded-full h-1.5 overflow-hidden">
          ...
          <div className="lg:col-span-4 bg-[#15241C] rounded-2xl p-6 sm:p-8 border border-white/10/90 shadow-xs hover:shadow-md transition-all flex flex-col justify-between">
            <div>
          ...
          <div className="lg:col-span-4 bg-[#15241C] rounded-2xl p-6 sm:p-8 border border-white/10/90 shadow-xs hover:shadow-md transition-all flex flex-col justify-between">
            <div>
              <div className="w-12 h-12 rounded-xl bg-blue-950/30 text-blue-700 flex items-center justify-center mb-4 border border-blue-200">
            ...
            <div className="mt-6 grid grid-cols-2 gap-2 text-xs font-semibold text-white">
              <div className="p-2.5 bg-[#0D1A13] rounded-lg border border-white/10">
                <div className="text-[10px] text-[#A5B8AC]">Consumo Sal</div>
                <div className="font-mono text-sm font-bold text-white">85 g / animal / día</div>
              </div>
              <div className="p-2.5 bg-[#0D1A13] rounded-lg border border-white/10">
                <div className="text-[10px] text-[#A5B8AC]">Stock Crítico</div>
          ...
          <div className="lg:col-span-4 bg-[#15241C] rounded-2xl p-6 sm:p-8 border border-white/10/90 shadow-xs hover:shadow-md transition-all flex flex-col justify-between">
            ...
            <div className="mt-6 flex items-center justify-between p-3 bg-[#0D1A13] rounded-xl border border-white/10 text-xs">
              <div className="flex items-center gap-2">
                <span className="w-2.5 h-2.5 rounded-full bg-emerald-500" />
                <span className="font-bold text-white">Tru-Test XR5000</span>
              </div>
              <span className="text-[#A5B8AC] font-mono text-[11px]">Sincronizado</span>
            </div>
          </div>
